...
export const OpulentoAvatarRing = ({ className = "", isStatic = false }) => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    >
      ...
      <circle
        ...
        strokeWidth="14"
        fill="none"
        className={`${isStatic ? '' : 'animate-vault-ring-rotate'} drop-shadow-[0_0_16px_rgba(250,204,21,0.6)]`}
      />
      ...
      <g transform="translate(130,130)">
        ...
        <circle
          ...
          className={`${isStatic ? '' : 'animate-vault-lock-pulse'}`}
        />
      </g>
    </svg>
