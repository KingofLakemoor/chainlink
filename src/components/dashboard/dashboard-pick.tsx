          ...
          <div className="p-5 flex flex-col items-center text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-4 w-full">
              <div className={cn("flex flex-col items-center gap-3 p-4 rounded-xl border relative w-48", activePick?.pick?.id === 'OVER' ? 'border-green-500 bg-green-500/10' : 'border-zinc-800 opacity-50')}>
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="text-xs font-semibold text-zinc-200 mt-1">{getTeamShortName(activeMatchup, false)}</span>
                </div>
            ...
            <div className="flex items-center justify-center gap-8 w-full">
              <div className={cn("flex flex-col items-center gap-3 p-4 rounded-xl border relative", activePick?.pick?.id === (activeMatchup.type === 'OVER_UNDER' ? 'OVER' : activeMatchup.awayTeam.id) ? 'border-green-500 bg-green-500/10' : 'border-zinc-800 opacity-50')}>
                <FirebaseImage src={activeMatchup.type === 'OVER_UNDER' ? '/images/over.png' : activeMatchup.awayTeam.image} fallback={activeMatchup.league === 'SCRIPTLESS' ? '/images/scriptless.png' : undefined} fallbackIcon={activeMatchup.league === 'SCRIPTLESS' ? undefined : <Link2 className="w-10 h-10 text-zinc-600" />} className="w-16 h-16 object-contain flex items-center justify-center" alt={activeMatchup.type === 'OVER_UNDER' ? 'OVER' : getTeamShortName(activeMatchup, false)} loading="lazy" />
                <span className="text-sm font-bold text-zinc-200">{activeMatchup.type === 'OVER_UNDER' ? 'OVER' : getTeamShortName(activeMatchup, false)}</span>
              ...
              <div className={cn("flex flex-col items-center gap-3 p-4 rounded-xl border relative", activePick?.pick?.id === (activeMatchup.type === 'OVER_UNDER' ? 'UNDER' : activeMatchup.homeTeam.id) ? 'border-green-500 bg-green-500/10' : 'border-zinc-800 opacity-50')}>
                <FirebaseImage src={activeMatchup.type === 'OVER_UNDER' ? '/images/under.png' : activeMatchup.homeTeam.image} fallback={activeMatchup.league === 'SCRIPTLESS' ? '/images/scriptless.png' : undefined} fallbackIcon={activeMatchup.league === 'SCRIPTLESS' ? undefined : <Link2 className="w-10 h-10 text-zinc-600" />} className="w-16 h-16 object-contain flex items-center justify-center" alt={activeMatchup.type === 'OVER_UNDER' ? 'UNDER' : getTeamShortName(activeMatchup, true)} loading="lazy" />
                <span className="text-sm font-bold text-zinc-200">{activeMatchup.type === 'OVER_UNDER' ? 'UNDER' : getTeamShortName(activeMatchup, true)}</span>
