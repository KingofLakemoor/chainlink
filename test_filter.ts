const m_startTime = new Date('2026-07-28T17:40:00.000Z').getTime(); // Just a test value
const campaign = {
  gamesBeginDate: new Date('2026-07-30T15:15:00.000Z').getTime(), // e.g. July 30, 8:15 AM PDT
  endDate: new Date('2027-01-29T00:00:00.000Z').getTime()
};
